...
public class WuziJuanzengView extends WuziJuanzengEntity implements Serializable {
	...
	*/
	...
	private String wuziJuanzengYesnoValue;
	...
	public WuziJuanzengView() {

	}

	public WuziJuanzengView(WuziJuanzengEntity wuziJuanzengEntity) {
		try {
			BeanUtils.copyProperties(this, wuziJuanzengEntity);
	...
	* 获取： 捐赠状态的值
	*/
	public String getWuziJuanzengYesnoValue() {
		return wuziJuanzengYesnoValue;
	}
	/**
	* 设置： 捐赠状态的值
	*/
	public void setWuziJuanzengYesnoValue(String wuziJuanzengYesnoValue) {
		this.wuziJuanzengYesnoValue = wuziJuanzengYesnoValue;
	}
	...
	public String toString() {
		return "WuziJuanzengView{" +
			", wuziJuanzengYesnoValue=" + wuziJuanzengYesnoValue +
			", wuziName=" + wuziName +
