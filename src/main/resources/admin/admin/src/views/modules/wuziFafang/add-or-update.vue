    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='wuzi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="所属仓库" prop="wuziCangku">
                        <el-input v-model="wuziForm.wuziCangku"
                                  placeholder="所属仓库" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="所属仓库" prop="wuziCangku">
                            <el-input v-model="ruleForm.wuziCangku"
                                      placeholder="所属仓库" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='wuzi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="物资位置" prop="wuziAddress">
                        <el-input v-model="wuziForm.wuziAddress"
                                  placeholder="物资位置" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="物资位置" prop="wuziAddress">
                            <el-input v-model="ruleForm.wuziAddress"
                                      placeholder="物资位置" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='wuzi' ">
            ...
            <input id="wuziId" name="wuziId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="物资发放编号" prop="wuziFafangUuidNumber">
                       <el-input v-model="ruleForm.wuziFafangUuidNumber"
                                 placeholder="物资发放编号" clearable  :readonly="ro.wuziFafangUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="物资发放编号" prop="wuziFafangUuidNumber">
                           <el-input v-model="ruleForm.wuziFafangUuidNumber"
                                     placeholder="物资发放编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="发放数量" prop="wuziFafangNumber">
                       <el-input v-model="ruleForm.wuziFafangNumber"
                                 placeholder="发放数量" clearable  :readonly="ro.wuziFafangNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="发放数量" prop="wuziFafangNumber">
                           <el-input v-model="ruleForm.wuziFafangNumber"
                                     placeholder="发放数量" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.rukuTime"  class="input" label="发放时间" prop="rukuTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.rukuTime"
                                type="datetime"
                                placeholder="发放时间"
                                :disabled="ro.rukuTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.rukuTime" label="发放时间" prop="rukuTime">
                            <span v-html="ruleForm.rukuTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="发放位置" prop="wuziFafangAddress">
                       <el-input v-model="ruleForm.wuziFafangAddress"
                                 placeholder="发放位置" clearable  :readonly="ro.wuziFafangAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="发放位置" prop="wuziFafangAddress">
                           <el-input v-model="ruleForm.wuziFafangAddress"
                                     placeholder="发放位置" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.wuziFafangContent"  label="发放缘由" prop="wuziFafangContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.wuziFafangContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.wuziFafangContent" label="发放缘由" prop="wuziFafangContent">
                            <span v-html="ruleForm.wuziFafangContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.wuziFafangBeizhuContent"  label="备注" prop="wuziFafangBeizhuContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.wuziFafangBeizhuContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.wuziFafangBeizhuContent" label="备注" prop="wuziFafangBeizhuContent">
                            <span v-html="ruleForm.wuziFafangBeizhuContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                ro:{
                    yuangongId: false,
                    wuziId: false,
                    wuziFafangUuidNumber: true,
                    wuziFafangNumber: false,
                    rukuTime: false,
                    wuziFafangAddress: false,
                    wuziFafangContent: false,
                    wuziFafangBeizhuContent: false,
                    insertTime: false,
                },
                ruleForm: {
                    yuangongId: '',
                    wuziId: '',
                    wuziFafangUuidNumber: new Date().getTime(),
                    wuziFafangNumber: '',
                    rukuTime: '',
                    wuziFafangAddress: '',
                    wuziFafangContent: '',
                    wuziFafangBeizhuContent: '',
                    insertTime: '',
                },
                wuziOptions : [],
                yuangongOptions : [],
                rules: {
                   ...
                   wuziFafangUuidNumber: [
                              { required: true, message: '物资发放编号不能为空', trigger: 'blur' },
                          ],
                   wuziFafangNumber: [
                   ...
                   wuziFafangAddress: [
                              { required: true, message: '发放位置不能为空', trigger: 'blur' },
                          ],
                   wuziFafangContent: [
                              { required: true, message: '发放缘由不能为空', trigger: 'blur' },
                          ],
                   wuziFafangBeizhuContent: [
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.wuziFafangContent = _this.ruleForm.wuziFafangContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                        _this.ruleForm.wuziFafangBeizhuContent = _this.ruleForm.wuziFafangBeizhuContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.wuziFafangContent = this.ruleForm.wuziFafangContent.replaceAll(this.$base.url,"");
                        this.ruleForm.wuziFafangBeizhuContent = this.ruleForm.wuziFafangBeizhuContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`wuziFafang/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.wuziFafangCrossAddOrUpdateFlag = false;
                                        this.parent.search();
