    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="wuziId" name="wuziId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="物资入库编号" prop="wuziRukuUuidNumber">
                       <el-input v-model="ruleForm.wuziRukuUuidNumber"
                                 placeholder="物资入库编号" clearable  :readonly="ro.wuziRukuUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="物资入库编号" prop="wuziRukuUuidNumber">
                           <el-input v-model="ruleForm.wuziRukuUuidNumber"
                                     placeholder="物资入库编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="入库数量" prop="wuziRukuNumber">
                       <el-input v-model="ruleForm.wuziRukuNumber"
                                 placeholder="入库数量" clearable  :readonly="ro.wuziRukuNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="入库数量" prop="wuziRukuNumber">
                           <el-input v-model="ruleForm.wuziRukuNumber"
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.rukuTime"  class="input" label="入库时间" prop="rukuTime">
                        <el-date-picker
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.rukuTime" label="入库时间" prop="rukuTime">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.wuziRukuContent"  label="入库备注" prop="wuziRukuContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.wuziRukuContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.wuziRukuContent" label="入库备注" prop="wuziRukuContent">
                            <span v-html="ruleForm.wuziRukuContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                ro:{
                    yuangongId: false,
                    wuziId: false,
                    wuziRukuUuidNumber: true,
                    wuziRukuNumber: false,
                    rukuTime: false,
                    wuziRukuContent: false,
                    insertTime: false,
                },
                ruleForm: {
                    yuangongId: '',
                    wuziId: '',
                    wuziRukuUuidNumber: new Date().getTime(),
                    wuziRukuNumber: '',
                    rukuTime: '',
                    wuziRukuContent: '',
                    insertTime: '',
                ...
                rules: {
                   ...
                   wuziRukuUuidNumber: [
                              { required: true, message: '物资入库编号不能为空', trigger: 'blur' },
                          ],
                   wuziRukuNumber: [
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.wuziRukuContent = _this.ruleForm.wuziRukuContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.wuziRukuContent = this.ruleForm.wuziRukuContent.replaceAll(this.$base.url,"");
                        this.$http({
