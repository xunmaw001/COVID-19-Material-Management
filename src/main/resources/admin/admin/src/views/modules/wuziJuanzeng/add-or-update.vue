    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="捐赠编号" prop="wuziJuanzengUuidNumber">
                       <el-input v-model="ruleForm.wuziJuanzengUuidNumber"
                                 placeholder="捐赠编号" clearable  :readonly="ro.wuziJuanzengUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="捐赠编号" prop="wuziJuanzengUuidNumber">
                           <el-input v-model="ruleForm.wuziJuanzengUuidNumber"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="捐赠缘由" prop="wuziJuanzengText">
                        <el-input type="textarea"  :readonly="ro.wuziJuanzengText" v-model="ruleForm.wuziJuanzengText" placeholder="捐赠缘由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.wuziJuanzengText" label="捐赠缘由" prop="wuziJuanzengText">
                            <span v-html="ruleForm.wuziJuanzengText"></span>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="捐赠数量" prop="wuziJuanzengNumber">
                       <el-input v-model="ruleForm.wuziJuanzengNumber"
                                 placeholder="捐赠数量" clearable  :readonly="ro.wuziJuanzengNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="捐赠数量" prop="wuziJuanzengNumber">
                           <el-input v-model="ruleForm.wuziJuanzengNumber"
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.wuziJuanzengYesnoTypes" label="捐赠状态" prop="wuziJuanzengYesnoTypes">
                        <el-input v-model="ruleForm.wuziJuanzengYesnoValue" placeholder="捐赠状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.wuziJuanzengYesnoText" label="捐赠回复" prop="wuziJuanzengYesnoText">
                        <span v-html="ruleForm.wuziJuanzengYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.wuziJuanzengShenheTime" label="回复时间" prop="wuziJuanzengShenheTime">
                        <span v-html="ruleForm.wuziJuanzengShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    wuziJuanzengUuidNumber: true,
                    wuziId: false,
                    yonghuId: false,
                    wuziJuanzengText: false,
                    wuziJuanzengNumber: false,
                    insertTime: false,
                    wuziJuanzengYesnoTypes: false,
                    wuziJuanzengYesnoText: false,
                    wuziJuanzengShenheTime: false,
                },
                ruleForm: {
                    wuziJuanzengUuidNumber: new Date().getTime(),
                    wuziId: '',
                    yonghuId: '',
                    wuziJuanzengText: '',
                    wuziJuanzengNumber: '',
                    insertTime: '',
                    wuziJuanzengYesnoTypes: '',
                    wuziJuanzengYesnoText: '',
                    wuziJuanzengShenheTime: '',
                },
                wuziJuanzengYesnoTypesOptions : [],
                wuziOptions : [],
                yonghuOptions : [],
                rules: {
                   wuziJuanzengUuidNumber: [
                   ...
                   wuziJuanzengText: [
                              { required: true, message: '捐赠缘由不能为空', trigger: 'blur' },
                          ],
                   wuziJuanzengNumber: [
                   ...
                   wuziJuanzengYesnoText: [
                              { required: true, message: '捐赠回复不能为空', trigger: 'blur' },
                          ],
                   wuziJuanzengShenheTime: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=wuzi_juanzeng_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.wuziJuanzengYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`wuziJuanzeng/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.wuziJuanzengCrossAddOrUpdateFlag = false;
                                        this.parent.search();
