            ...
            <el-form :model="form">
                ...
                <el-form-item label="审核" >
                    <el-select v-model="form.wuziYuyueYesnoTypes" placeholder="请选择申请状态">
                        <el-option label="同意申请" value="2"></el-option>
                        <el-option label="拒绝申请" value="3"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="申请回复">
                    <el-input type="textarea" v-model="form.wuziYuyueYesnoText" placeholder="申请回复"></el-input>
                </el-form-item>
            </el-form>
            ...
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '申请编号' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.wuziYuyueUuidNumber" placeholder="申请编号" clearable></el-input>
                     </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xinguanwuzi/upload/wuziYuyueMuBan.xls"
                        >批量导入物资申请数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('wuziYuyue','导入导出')"
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                //级联表字段
                     ...
                     '账户状态': 'jinyongTypes',
                //本表字段
                     '申请编号': "wuziYuyueUuidNumber",
                     '申请缘由': "wuziYuyueText",
                     '申请数量': "wuziYuyueNumber",
                     '物资申请时间': "insertTime",
                     '申请状态': "wuziYuyueYesnoValue",
                     '申请回复': "wuziYuyueYesnoText",
        ...
        methods: {
            ...
            wuziYuyueYesnoTypesShenhe() {
                ...
                if(_this.form.wuziYuyueYesnoText == null || _this.form.wuziYuyueYesnoText == ""){
                    _this.$message.error("请输入申请回复");return false;
                }
                this.$http({
