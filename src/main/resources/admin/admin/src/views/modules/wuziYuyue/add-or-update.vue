    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="申请编号" prop="wuziYuyueUuidNumber">
                       <el-input v-model="ruleForm.wuziYuyueUuidNumber"
                                 placeholder="申请编号" clearable  :readonly="ro.wuziYuyueUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="申请编号" prop="wuziYuyueUuidNumber">
                           <el-input v-model="ruleForm.wuziYuyueUuidNumber"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="申请缘由" prop="wuziYuyueText">
                        <el-input type="textarea"  :readonly="ro.wuziYuyueText" v-model="ruleForm.wuziYuyueText" placeholder="申请缘由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.wuziYuyueText" label="申请缘由" prop="wuziYuyueText">
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.wuziYuyueYesnoText" label="申请回复" prop="wuziYuyueYesnoText">
