               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="所属仓库" prop="wuziCangku">
                       <el-input v-model="ruleForm.wuziCangku"
                                 placeholder="所属仓库" clearable  :readonly="ro.wuziCangku"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="物资位置" prop="wuziAddress">
                       <el-input v-model="ruleForm.wuziAddress"
                                 placeholder="物资位置" clearable  :readonly="ro.wuziAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   wuziAddress: [
                              { required: true, message: '物资位置不能为空', trigger: 'blur' },
                          ],
                   wuziTypes: [
