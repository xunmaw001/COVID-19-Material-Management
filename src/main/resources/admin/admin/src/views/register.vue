    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">新冠物资管理注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <!--
                            <el-form-item label="账户状态" class="input" v-if="tableName=='yuangong'">
                                <el-input v-model="ruleForm.jinyongTypes" autocomplete="off" placeholder="账户状态"  />
                           </el-form-item>
                        -->
                        <!--
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/xinguanwuzi/img/back-img-bg.jpg);
